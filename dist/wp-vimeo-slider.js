...
var _VimeoSlider = __webpack_require__(37);

var _VimeoSlider2 = _interopRequireDefault(_VimeoSlider);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _VimeoSlider2.default;
...
var StyledVideoContainer = _styledComponents2.default.div(_templateObject3);
...
var VimeoSlider = function (_React$Component) {
  ...
  function VimeoSlider(props) {
    ...
    var _this = _possibleConstructorReturn(this, (VimeoSlider.__proto__ || Object.getPrototypeOf(VimeoSlider)).call(this, props));
    ...
    _this.fetchPosts = function () {
      var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _this.props,
          ...
          vimeoPostsEndpoint = _ref.vimeoPostsEndpoint;
      ...
      return _react2.default.createElement(
        ...
        posts.map(function (post) {
          return _react2.default.createElement(
            ...
            { key: post.id },
            _react2.default.createElement(_Video.Video, { post: post })
          );
        })
      );
    };
...
VimeoSlider.propTypes = {
  totalPosts: _propTypes2.default.number,
  vimeoPosts: _propTypes2.default.array,
...
var StyledVideo = _styledComponents2.default.a(_templateObject);

var StyledVideoInner = _styledComponents2.default.div(_templateObject2);

var getVideoFile = function getVideoFile(files) {
  try {
...
var Video = exports.Video = function Video(_ref) {
  ...
  var file = getVideoFile(post.vimeo_data.files);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'video',
        { width: file.width, height: file.height, controls: true },
        _react2.default.createElement('source', { src: file.link, type: file.type })
      )
    )
  );
};
